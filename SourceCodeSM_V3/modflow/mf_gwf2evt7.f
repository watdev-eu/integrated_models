      !MODULE GWFEVTMODULE
	MODULE gwfevtmodule
        real, allocatable, save :: EVTvol(:,:,:) !added to track volumetric flow rate of ET, tcw
...
C1------ALLOCATE SCALAR VARIABLES.
      ...
      !added to initalize and record water content array (ET) for use by SWAT-MODFLOW, rtb, tcw
      allocate(EVTvol(NCOL,NROW,NLAY)) !tcw
      EVTvol = 0. !tcw
C
C2------IDENTIFY PACKAGE.
      IEVTPF=0
...
C     ------------------------------------------------------------------
      ...
      USE GWFEVTMODULE,ONLY:NEVTOP,IEVTCB,EVTR,EXDP,SURF,IEVT,EVTvol
C

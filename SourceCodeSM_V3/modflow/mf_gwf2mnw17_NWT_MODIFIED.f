...
c
      ...
      TYPE GWFMNWTYPE
        CHARACTER(LEN=200),    POINTER :: MNWNAMEV1
        INTEGER,               POINTER :: NWELL2V1,MXWEL2V1,IWL2CBV1
        INTEGER,               POINTER :: IWELPTV1,NOMOITERV1,KSPREFV1
        DOUBLE PRECISION,      POINTER :: PLOSSV1
        DOUBLE PRECISION,      POINTER :: SMALLV1,HMAXV1
        CHARACTER(LEN=32),     DIMENSION(:),    POINTER :: MNWSITEV1
        INTEGER,               DIMENSION(:),    POINTER :: IOWELL2V1
        DOUBLE PRECISION,      DIMENSION(:,:),  POINTER :: WELL2V1
        DOUBLE PRECISION,      DIMENSION(:,:,:),POINTER :: HREFV1
      END TYPE
...
c     ------------------------------------------------------------------
      ...
      INTRINSIC CHAR, ABS
      INTEGER, EXTERNAL :: IFRL
      !EXTERNAL IOWELLOUT ! MODIFICATION 
c Arguments
...
C     ------------------------------------------------------------------
      IDUM=IGRID
      DEALLOCATE (GWFMNWDAT(Igrid)%NWELL2V1)
      DEALLOCATE (GWFMNWDAT(Igrid)%MXWEL2V1)
      DEALLOCATE (GWFMNWDAT(Igrid)%IWL2CBV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%NOMOITERV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%KSPREFV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%IWELPTV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%PLOSSV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%SMALLV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%HMAXV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%MNWNAMEV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%IOWELL2V1)
      DEALLOCATE (GWFMNWDAT(Igrid)%HREFV1)
      DEALLOCATE (GWFMNWDAT(Igrid)%WELL2V1)
      DEALLOCATE (GWFMNWDAT(Igrid)%MNWSITEV1)
C
...
C Arguments
      INTEGER :: Igrid
C     ------------------------------------------------------------------
      NWELL2=>GWFMNWDAT(Igrid)%NWELL2V1
      MXWEL2=>GWFMNWDAT(Igrid)%MXWEL2V1
      IWL2CB=>GWFMNWDAT(Igrid)%IWL2CBV1
      NOMOITER=>GWFMNWDAT(Igrid)%NOMOITERV1
      KSPREF=>GWFMNWDAT(Igrid)%KSPREFV1
      IWELPT=>GWFMNWDAT(Igrid)%IWELPTV1
      PLOSS=>GWFMNWDAT(Igrid)%PLOSSV1
      SMALL=>GWFMNWDAT(Igrid)%SMALLV1
      HMAX=>GWFMNWDAT(Igrid)%HMAXV1
      MNWNAME=>GWFMNWDAT(Igrid)%MNWNAMEV1
      IOWELL2=>GWFMNWDAT(Igrid)%IOWELL2V1
      HREF=>GWFMNWDAT(Igrid)%HREFV1
      WELL2=>GWFMNWDAT(Igrid)%WELL2V1
      MNWSITE=>GWFMNWDAT(Igrid)%MNWSITEV1
C
...
C Arguments
      INTEGER :: Igrid
C     ------------------------------------------------------------------
      GWFMNWDAT(Igrid)%NWELL2V1=>NWELL2
      GWFMNWDAT(Igrid)%MXWEL2V1=>MXWEL2
      GWFMNWDAT(Igrid)%IWL2CBV1=>IWL2CB
      GWFMNWDAT(Igrid)%NOMOITERV1=>NOMOITER
      GWFMNWDAT(Igrid)%KSPREFV1=>KSPREF
      GWFMNWDAT(Igrid)%IWELPTV1=>IWELPT
      GWFMNWDAT(Igrid)%PLOSSV1=>PLOSS
      GWFMNWDAT(Igrid)%SMALLV1=>SMALL
      GWFMNWDAT(Igrid)%HMAXV1=>HMAX
      GWFMNWDAT(Igrid)%MNWNAMEV1=>MNWNAME
      GWFMNWDAT(Igrid)%IOWELL2V1=>IOWELL2
      GWFMNWDAT(Igrid)%HREFV1=>HREF
      GWFMNWDAT(Igrid)%WELL2V1=>WELL2
      GWFMNWDAT(Igrid)%MNWSITEV1=>MNWSITE
C

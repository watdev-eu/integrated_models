...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      do curyr = 1, nbyr
       ...
       !MODIFICATION
	IF(useDSSAT)THEN
	   ! Call DSSAT routines thorough interface 
	   call interface_plant_inityr
	END IF   
       ...
       !loop through the days of the current year
       do i = id1, idlst

          !increment day (cumulative for entire simulation)
          day_total = day_total + 1 !rtb

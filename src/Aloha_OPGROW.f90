...
!         Initialize daily growth output file
 ...
 '!                       Leaf   Grow        <--------------------------- Dry  Weight --------------------------->',&
' !  Harv <--- Eye ---> <-- Stress (0-1) -->   Leaf   Spec   Root',&
!'  <--------------- Root Length Density ------------------------------>', &
 '!                        Num  Stage    LAI   Tops    Veg   Leaf   Stem Flower  Fruit  Crown  Basal   Suck   Root',&
!'  Index   Wgt.    No.',&
!'      Water      Nitr   Nitr   Leaf  Depth  <---------------   cm3/cm3  of soil  ------------------------------>', &
 '!                                          <------------------------------ kg/Ha ------------------------------>',&
!'         kg/ha          Phot   Grow             %   Area      m  <------------------------------------------------------------------>', &
 '@YEAR DOY   DAS   DAP   L#SD   GSTD   LAID   CWAD   VWAD   LWAD   SWAD  FLWAD   FWAD   CRAD   BWAD   SUGD   RWAD   HIAD  EYWAD'&
 ' EY#AD   WSPD   WSGD   NSTD   LN%D   SLAD   RDPD   RL1D   RL2D   RL3D   RL4D   RL5D   RL6D   RL7D   RL8D   RL9D   RL10'

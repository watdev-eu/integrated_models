...
!	write(*,*)'CENTURY: IDETL',IDETL,'TO SOMLITPRINT_C'
...
!	write(*,*)'CENTURY, to TSOMLIT_C again'
      CALL TSOMLIT_C ( 
     &  METABC, METABE, N_ELEMS, NLAYR, SOILPROP,         !Input
     &  SOM1C, SOM1E, SOM2C, SOM2E, SOM23E, SOM3C,        !Input
     &  SOM3E, STRUCC, STRUCE,                            !Input
...
!     initialization (SOM initialization was printed from SoilCNPinit_C
	!write(*,*)'CENTURY,to SOMLITPRINT_C'
...
!     &    SOM1C, TLITC, TSOMC, YRDOY)                     !Input
     ...
     &  SSOMC, TLITC, TSOMC, YRDOY)                       !Input
	!MODIFICATION JJ 
	CALL PUT('ToSwat','SOM1E1',SOM1E(:,1))
        CALL PUT('ToSwat','SOM1E2',SOM1E(:,2))
        CALL PUT('ToSwat','SOM1E3',SOM1E(:,3))
        CALL PUT('ToSwat','SOM2E1',SOM2E(:,1))
        CALL PUT('ToSwat','SOM2E2',SOM2E(:,2))
        CALL PUT('ToSwat','SOM2E3',SOM2E(:,3))
        CALL PUT('ToSwat','SOM3E1',SOM3E(:,1))
        CALL PUT('ToSwat','SOM3E2',SOM3E(:,2))
        CALL PUT('ToSwat','SOM3E3',SOM3E(:,3))
        CALL PUT('ToSwat','SOM23E1',SOM23E(:,1))
        CALL PUT('ToSwat','SOM23E2',SOM23E(:,2))
        CALL PUT('ToSwat','SOM23E3',SOM23E(:,3))

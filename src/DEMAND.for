...
!-----------------------------------------------------------------------
	...
	PlantG2%YVREF=YVREF
	PlantG2%YTRFAC=YTRFAC
	PlantG2%YSTEM=YSTEM
	PlantG2%YSLATM=YSLATM
	PlantG2%YLEAF=YLEAF	
	PlantG2%XXFTEM=XXFTEM
	PlantG2%XVGROW=XVGROW
	PlantG2%XTRFAC=XTRFAC	
	PlantG2%XSLATM=XSLATM
	PlantG2%XLEAF=XLEAF	
	PlantG2%XFRUIT=XFRUIT
	PlantG2%XFRMAX=XFRMAX
	PlantG2%VSSINK=VSSINK
	PlantG2%TYPSDT=TYPSDT
	PlantG2%TURSLA=TURSLA
	PlantG2%THRESH=THRESH
	PlantG2%SRMAX=SRMAX
	PlantG2%SIZREF=SIZREF	
	PlantG2%SIZELF=SIZELF
	PlantG2%SLOSUM=SLOSUM
	PlantG2%SLAVAR=SLAVAR	
	PlantG2%SLAREF=SLAREF
	PlantG2%SLAPAR=SLAPAR
	PlantG2%SLAMIN=SLAMIN
	PlantG2%SLAMAX=SLAMAX
	PlantG2%RLIG=RLIG
	PlantG2%RLIP=RLIP
	PlantG2%RMIN=RMIN
	PlantG2%RNO3C=RNO3C
	...
	PlantG2%CARMIN=CARMIN
	PlantG2%FINREF=FINREF
	PlantG2%FNSDT=FNSDT
	PlantG2%FRLFF=FRLFF
	PlantG2%FRLFMX=FRLFMX
	PlantG2%FRSTMF=FRSTMF
	PlantG2%LIPOPT=LIPOPT
	PlantG2%LIPTB=LIPTB
	PlantG2%LNGSH=LNGSH
	PlantG2%NMOBMX=NMOBMX
	PlantG2%NRCVR=NRCVR
	PlantG2%NVSMOB=NVSMOB
	PlantG2%RCH2O=RCH2O
...
!-----------------------------------------------------------------------
	CALL GET(PlantG2)
      ...
      RPRPUN = 1.0 
      TMPFAC = 1.0
	PlantG2%CDMSDR=CDMSDR
	PlantG2%GDMSDR=GDMSDR	
	PlantG2%FNINSD=FNINSD
	PlantG2%NDMNEW=NDMNEW
	PlantG2%NDMREP=NDMREP
	PlantG2%NDMSD=NDMSD
	PlantG2%NDMSH=NDMSH
	PlantG2%NDMSDR=NDMSDR
	PlantG2%NDMVEG=NDMVEG
	PlantG2%NMOBR=NMOBR
	PlantG2%SDGR=SDGR
	PlantG2%FNINL=FNINL
	PlantG2%FNINS=FNINS
	PlantG2%FNINR=FNINR
	PlantG2%NMINEP=NMINEP
	PlantG2%RPRPUN=RPRPUN
	PlantG2%TMPFAC=TMPFAC
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
	...
	XLEAF=PlantG2%XLEAF
	YLEAF=PlantG2%YLEAF
	FINREF=PlantG2%FINREF
	SLAMAX=PlantG2%SLAMAX
	SLAMIN=PlantG2%SLAMIN
      IF (CROP .NE. 'FA') THEN
...
!-----------------------------------------------------------------------
        ...
        FRRT = 1.0 - FRLF - FRSTM
	PlantG2%DUMFAC=DUMFAC
	PlantG2%F=F
	PlantG2%FVEG=FVEG
	PlantG2%SLAMN=SLAMN
	PlantG2%SLAMX=SLAMX
	PlantG2%GROMAX=GROMAX
	PlantG2%SIZRAT=SIZRAT
	PlantG2%YVGROW=YVGROW
	PlantG2%FRLF=FRLF
	PlantG2%FRSTM=FRSTM
	PlantG2%FRRT=FRRT	
...
!-----------------------------------------------------------------------
	...
	PROLFI=PlantG2%PROLFI
	PRORTI=PlantG2%PRORTI
	PROSTI=PlantG2%PROSTI


	XFRUIT=PlantG2%XFRUIT
...
!***********************************************************************
	...
	CARMIN=PlantG2%CARMIN
	FINREF=PlantG2%FINREF
	FNSDT=PlantG2%FNSDT
	FRLFF=PlantG2%FRLFF
	FRLFMX=PlantG2%FRLFMX
	FRSTMF=PlantG2%FRSTMF
	LIPOPT=PlantG2%LIPOPT
	LIPTB=PlantG2%LIPTB
	LNGSH=PlantG2%LNGSH
	NMOBMX=PlantG2%NMOBMX
	NRCVR=PlantG2%NRCVR
	NVSMOB=PlantG2%NVSMOB
	PLIGSD=PlantG2%PLIGSD
	PMINSD=PlantG2%PMINSD
	POASD=PlantG2%POASD
	PROLFF=PlantG2%PROLFF
	PROLFI=PlantG2%PROLFI
	PRORTF=PlantG2%PRORTF
	PRORTI=PlantG2%PRORTI
	PROSTF=PlantG2%PROSTF
	PROSTI=PlantG2%PROSTI
	RCH2O=PlantG2%RCH2O
	RLIG=PlantG2%RLIG
	RLIP=PlantG2%RLIP
	...
	SLAMAX=PlantG2%SLAMAX
	SLAMIN=PlantG2%SLAMIN
	SLAPAR=PlantG2%SLAPAR
	SLAREF=PlantG2%SLAREF
	SLAVAR=PlantG2%SLAVAR
	SLOSUM=PlantG2%SLOSUM
	SIZELF=PlantG2%SIZELF
	SIZREF=PlantG2%SIZREF
	SRMAX=PlantG2%SRMAX
	THRESH=PlantG2%THRESH
	TURSLA=PlantG2%TURSLA
	TYPSDT=PlantG2%TYPSDT
	VSSINK=PlantG2%VSSINK
	XFRMAX=PlantG2%XFRMAX
	XFRUIT=PlantG2%XFRUIT
	XLEAF=PlantG2%XLEAF
	XSLATM=PlantG2%XSLATM
	XTRFAC=PlantG2%XTRFAC
	XVGROW=PlantG2%XVGROW
	XXFTEM=PlantG2%XXFTEM
	YLEAF=PlantG2%YLEAF
	YSLATM=PlantG2%YSLATM
	YSTEM=PlantG2%YSTEM
...
!-----------------------------------------------------------------------
     ...
     &                  XXFTEM(10), YXFTEM(10)
        REAL XLEAF(25), YLEAF(25), YSTEM(25)
	IF(useSWAT)THEN
		CALL interface_DEMAND(ECONO,SLAVAR,SIZELF,XFRUIT,
     &THRESH,SDPRO,SDLIP)
	!ECONO='CO0001'
	!SLAVAR
	!SIZELF

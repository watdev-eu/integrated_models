...
!     Initialize daily
      ...
      FERPOT = 0.0
	IFERI=ISWITCH%IFERI
!	write(*,*)'Fert_Place: YRDOY=', YRDOY,'UIDATA%UIEND=',UIDATA%UIEND
      IF (YRDOY .EQ. UIDATA % UIEND) THEN
        UIDATA % UIEFF = 0.0
        UIDATA % UIEND = YRDOY
      ENDIF
!	write(*,*)'NIDATA%NIEND=',NIDATA%NIEND
...
!       ------------------------------------------------------------------
     ...
     &      (FDAY(I) == 0 .AND. YRDOY == YRPLT)) THEN
          ...
          ELSEIF (FDAY(I) .GT. DAP) THEN
            EXIT FertLoop
          ENDIF
	ELSE ! Modification JJ 
		IF(NFERT==1.AND.IFERI=='F')THEN
		FERTILIZE_TODAY=.TRUE.
		FERDEP(I)=FertData%FERDEPTH
		FERTYP(I)=FertData%FERTYPE
		FERMET(I)='   03'
		FERTYPE=3
		ANFER(I)=10
		APFER(I)=10
...
!				
        ...
        ENDIF
!	write(*,*)'Fert_Place, FERT_TODAY=',FERTILIZE_TODAY
...
!         N fertilizer
          ...
          NAPFER(N) = NAPFER(N) + 1
	 ! write(*,*) 'FERNIT=',FERNIT,'FERNO3=',FERNO3,'FERNH4=',FERNH4
	!	write(*,*)'FERUREA=',FERUREA,'AMTFER=',AMTFER(N),'NAPFER=',NAPFER(N)
	!STOP
...
!         Calculation of fertilizer release curve
        ...
        ENDIF
!	write(*,*)FERNIT,'>',1.E-3,FERPHOS,'>',1.E-3,FERPOT,'>',1.E-3
...
!	write(*,*)'AppType=',AppType,'FERMIXPERC=',FERMIXPERC
!	write(*,*)'FMIXEFF=',FMIXEFF,'KMAX=',KMAX,'PROF=',PROF
!	write(*,*)'UNINCO=',UNINCO
...
!           Don't add any N now for slow release fertilizers. 
            ...
            FERUREA = 0.0
          ENDIF
!	write(*,*)'FERNH4=',FERNH4,'FERNO3=',FERNO3,'FERUREA=',FERUREA
	FLOOD=0.0
          CALL FertApply(
...
!	write(*,*)'From FertApply'
!	write(*,*)'ADDFUREA=',ADDFUREA,'ADDFNH4=',ADDFNH4
!	write(*,*)'ADDFNO3=',ADDFNO3
!	write(*,*)'ADDOXU=',ADDOXU,'ADDOXH4=',ADDOXH4
!	write(*,*)'ADDOXN3=',ADDOXN3
!	write(*,*)'ADDSNH4=',ADDSNH4,'ADDSNO3=',ADDSNO3
!	write(*,*)'ADDUREA=',ADDUREA
!	write(*,*)'ADDSPi=',ADDSPi,'ADDSKi=',ADDSKi
!	STOP

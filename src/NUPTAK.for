...
!-----------------------------------------------------------------------
	...
	TYPE(Plant_GROWTH) PlantK
	!write(*,*)'NUPTAK,DYNAMIC=',DYNAMIC
	!write(*,*)'RUNINIT;SEASINIT',RUNINIT,SEASINIT
!***********************************************************************
!***********************************************************************
...
!	write(*,*)'NUPTAK,ANDEM=',ANDEM,'Nitrogen DEMAND '
!	write(*,*)'NDMSDR=',NDMSDR

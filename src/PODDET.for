...
!-----------------------------------------------------------------------
	...
	PlantP%DWC=DWC
	PlantP%PR1DET=PR1DET
	PlantP%PR2DET=PR2DET
	PlantP%XP1DET=XP1DET
	PlantP%XP2DET=XP2DET
      ENDIF
...
C--------------------------------------------------------------------
	...
	TM=PlantP%TM
	DWC=PlantP%DWC
	PR1DET=PlantP%PR1DET
	PR2DET=PlantP%PR2DET
	XP1DET=PlantP%XP1DET
	XP2DET=PlantP%XP2DET
	DTC=PlantP%DTC
	MSHELN=PlantP%MSHELN
	WPODY=PlantP%WPODY
	DAYS=PlantP%DAYS
      FT = 0.0
      DO I = 1,TS

...
!     P state variables by weight (kg/ha)
      REAL PShut_kg, PRoot_kg, PShel_kg, PSeed_kg, PPlant_kg,PPlant2_kg
...
!     P[kg/ha] variables
      ...
      PSeed_kg  = 0.0
      PPlant_kg = 0.0
      PPlant2_kg=0.0 ! JJ added to be similar than in a swat
      CALL GET(ToSwat)
	ToSwat%PPlant2_kg=PPlant2_kg
	CALL PUT(ToSwat)
...
!     Plant P (kg/ha)
      ...
      PPlant2_kg=PShut_kg+Pshel_kg+Pseed_kg
	CALL GET(ToSwat)
	ToSwat%PPlant2_kg=PPlant2_kg
	CALL PUT(ToSwat)	
      CALL OPPlantP(DYNAMIC, MDATE, YRPLT, 
...
!     Senesced plant matter - reduce P
      ...
      PPlant2_kg=PPlant2_kg-SenSurfP ! JJ added
...
!     Pest damage
      ...
      PPlant_kg = PPlant_kg - 
     &        (PestShutP + PestRootP + PestShelP + PestSeedP)
      PPlant2_kg=PPlant2_kg-(PestShutP+PestShelP+PestSeedP)	
!     ------------------------------------------------------------------
...
!     P mass in plant matter (kg/ha)
      ...
      PPlant2_kg = PPlant2_kg+PUptakeProf

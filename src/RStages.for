...
C-------------------------------------------------------------------------------
!	write(*,*)'RSTAGE,DAS=',DAS,'N(N)=',NVALPH(NPRIOR(2))
!	write(*,*)'NVEG1=',NVEG1,'NVALP0=',NVALP0
...
C-------------------------------------------------------------------------------
!	write(*,*)'RSTAGES,N(N)=',NVALPH(NPRIOR(3)),'JPEND=',JPEND
!	write(*,*)'NVALP0=',NVALP0
...
C-------------------------------------------------------------------------------
!	write(*,*)'N(N)=',NVALPH(NPRIOR(4)),'NR0=',NR0,'NVALP0=',NVALP0
...
C-------------------------------------------------------------------------------
!	write(*,*)'NVALPH(NPRIOR(5))=',NVALPH(NPRIOR(5)),'NR1=',NR1
...
C-------------------------------------------------------------------------------
!	write(*,*)'N(N)=',NVALPH(NPRIOR(10)),'NR7=',NR7
...
C-------------------------------------------------------------------------------
!	write(*,*)'RSTAGES,INTEG,NDLEAF=',NDLEAF,'DAS=',DAS,
!     &	'NVALPH(NPIOR(13))=', NVALPH(NPRIOR(13))

...
!     elevations (DSINBE)
      ...
      dsinbe = 2.0d0*3600.0d0*(dayl*(0.50d0*sinld+0.20d0*sinld**2.0d0+0.10d0*cosld**2.0d0)&
-(12.0d0*cosld*zzcos+9.6d0*sinld*cosld*zzcos+2.4d0*cosld**2.0d0*zzcos*zzsin)/pi)

...
!       --------------------------------------------------------------
	IF(useSWAT)THEN
	!write(*,*)'RNMODE=',RNMODE,INDEX('QF',RNMODE)
	call interface_CNPinit(PREV_CROP,ICRT,ICNOD,ICRES,
     &ICREN,ICREP,ICRIP,ICRID)
	!write(*,*)'SOilCNPinit_c needs inputs'
	!PREV_CROP,ICRT,ICNOD,ICRE,ICREN,ICREP,ICRIP,ICRID,
	ELSE

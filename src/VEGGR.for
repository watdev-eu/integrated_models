...
!-----------------------------------------------------------------------
	...
	PlantG4%PROLFI=PROLFI!  
	PlantG4%PROLFG=PROLFG !" 
	PlantG4%PROSTI=PROSTI!
	PlantG4%PROSTG=PROSTG!
        CALL IGNORE(LUNCRP,LNUM,ISECT,C80)
        READ(C80,'(2F6.0)',IOSTAT=ERR) PRORTI, PRORTG
        IF (ERR .NE. 0) CALL ERROR(ERRKEY,ERR,FILECC,LNUM)
	PlantG4%PRORTI=PRORTI!
	PlantG4%PRORTG=PRORTG!
      ENDIF
!-----------------------------------------------------------------------
!    Find and Read Plant Composition Section
!-----------------------------------------------------------------------
      ...
      ELSE
        ...
        IF (ERR .NE. 0) CALL ERROR(ERRKEY,ERR,FILECC,LNUM)
	PlantG4%CMOBMX=CMOBMX! 
	PlantG4%CADSTF=CADSTF !
      ENDIF
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
	CALL GET(PlantG4)
      ...
      PlantG4%CADLF  = CADLF
      PlantG4%CADST  = CADST
      PlantG4%CMINEA = CMINEA
      PlantG4%CRUSLF = CRUSLF
      PlantG4%CRUSRT = CRUSRT
      PlantG4%CRUSST = CRUSST
      PlantG4%CUMTUR = CUMTUR
      PlantG4%EXCESS = EXCESS
      PlantG4%FNINLG = FNINLG
      PlantG4%FNINRG = FNINRG
      PlantG4%FNINSG = FNINSG
      PlantG4%NADLF  = NADLF
      PlantG4%NADRT  = NADRT
      PlantG4%NADST  = NADST
      PlantG4%NGRLF  = NGRLF
      PlantG4%NGRRT  = NGRRT
      PlantG4%NGRST  = NGRST
      PlantG4%NSTRES = NSTRES
      PlantG4%PGLEFT = PGLEFT
      PlantG4%SUPPN  = SUPPN
      PlantG4%TNLEAK = TNLEAK
      PlantG4%VGRDEM = VGRDEM
      PlantG4%WLDOTN = WLDOTN
      PlantG4%WRDOTN = WRDOTN
      PlantG4%WSDOTN = WSDOTN
...
!	write(*,*)'VEGGR,SUPPN=',SUPPN,'FFIXN=',NFIXN
!	write(*,*)'TRNU=',TRNU,'NMINEA=',NMINEA
...
!	write(*,*)'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'	
	!if(pgavl==0)STOP
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
	...
	PlantG4%NGRVEG=NGRVEG
!	write(*,*)'Maximum N required for tissue growth'
!	write(*,*)'NGRLF=',NGRLF
!	write(*,*)'NGRST=',NGRST
!	write(*,*)'NGRRT=',NGRRT
!	write(*,*)'NGRVEG=',NGRVEG
...
C-----------------------------------------------------------------------
      ...
      PlantG4%NGRLFG=NGRLFG
      PlantG4%NGRSTG=NGRSTG
      PlantG4%NGRRTG=NGRRTG
      PlantG4%NGRVGG=NGRVGG	
      NRATIO = 1.0
...
!	write(*,*)'MINIMUM N for tissue GROWTH, upper'
!	write(*,*)'NAVL=',NAVL

      IF (NAVL .LT. NGRVGG) THEN
!	write(*,*)'VEGG:NAVL=',NAVL,'NGRVGG=',NGRVGG
C-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
	PROLFI=PlantG4%PROLFI
	PROSTI=PlantG4%PROSTI
	PRORTI=PlantG4%PRORTI
...
!	write(*,*)'CADSTF=',CADSTF
      ...
      ENDIF
!	write(*,*)'LSTR=',LSTR,'STMWT=',STMWT,'WTLF=',WTLF
...
!	write(*,*)'Place1 CADST=',CADST
!	write(*,*)'PGLEFT=',PGLEFT,'CMINEP=',CMINEP
!	write(*,*)'LSTR=',LSTR,'PCH2O=',PCH2O
!Place1
      ELSE
...
!	write(*,*)'VEGG 2,CADST=',CADST,'CSAVEV=',CSAVEV
!	write(*,*)'LSTR=',LSTR,'PCH20=',PCH2O
!Paikka2
C-----------------------------------------------------------------------
...
!	 write(*,*)'NLEFT=',NLEFT
!	write(*,*)'FRLF=',FRLF,'FNINL=',FNINL
!	write(*,*)'FRSTM=',FRSTM,'FNINS=',FNINS
!	write(*,*)'FRRT=',FRRT,'FNINR=',FNINR 
...
!	write(*,*)'Place 1'
         ...
         NADRT  = 0.0
      ENDIF
!	write(*,*)'NLEFT=',NLEFT,'FRSTM=',FRSTM,'FNINS=',FNINS!
!	write(*,*)'FRRT=',FRRT,'FNINR=',FNINR
!	write(*,*)'VEGGR:NADLF=',NADLF,'NADRAT=',NADRAT,'FRLF=',FRLF
!	write(*,*)'FNINL=',FNINL
C-----------------------------------------------------------------------

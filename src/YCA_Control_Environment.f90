...
! MODIFICATION Linte truncate by JJ 11.4.2024               
        hourlyBiomass = calculateBiomass(calculatateHourlyRadiation(hour, DAWN_TIME, this%dayRadiation_ , LIGHT_HOURS) ,&
 extinctionCoefficient , LAI, radiationUseEfficiency, stomatalConductance )
    ...
    real function calculateBiomass(radiation, extinctionCoefficient , LAI, radiationUseEfficiency, stomatalConductance)
        ...
        calculateBiomass = calculatePortionOfRadiation(extinctionCoefficient, LAI) * radiation&
        * radiationUseEfficiency  * stomatalConductance

...
!MODIFICATION 11.4.2024 by JJ	
    real function availableCarbohydrate_methodV(PARMJFAC, SRAD, PARU, CO2FP, TFP, RSFP, SLPF, PARI,&
 PLTPOP, LAI, WFP, WEATHER, CONTROL, SOILPROP)
        USE ModuleDefs
...
! MODIFICATIOPN LINE TRUNCATED BY JJ 11.4.2024
            CARBOTMPRHR(hour) = AMAX1(0.0,(PARMJFAC*RADHR(hour)*3.6/1000.)*PARU*CO2FP*&
TFP* RSFP * VPD%get_YCA_VPDFPHR(hour) * SLPF *WFP)       ! MF 17SE14 RADHR is in J/m2/s. Multiply by 3600 for hour, divide by 10^6 for MJ.

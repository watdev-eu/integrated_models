...
!-----------------------------------------------------------------------
	...
	! MODIFICATION LINES TRUNCATED BY JJ 11.4.2024
                availableCH2O = availableCarbohydrate_methodR(PARMJFAC, SRAD, PARU, CO2FP, TFP, RSFP, VPDFP,&
 SLPF, PARI, PLTPOP, WFP)
            case ('V')
                availableCH2O = availableCarbohydrate_methodV(PARMJFAC, SRAD, PARU, CO2FP, TFP, RSFP, SLPF, &
PARI, PLTPOP, LAI, WFP, WEATHER, CONTROL, SOILPROP)
        end select

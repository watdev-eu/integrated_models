	...
	real,dimension(:),allocatable::DRN_SWAT
      ...
      real, dimension (:), allocatable :: rttlc
      integer, dimension (:), allocatable :: rch_layer
      logical :: normOut
      integer :: day_total
      logical :: computegw, computenutr, initializeRCHloss
      real, dimension (:), allocatable :: rchrg_no3_conc
      real, dimension (:), allocatable :: rchrg_p_conc
...
!! septic variables for output.std
      ...
      real :: rttime, rchdep, rtevp, da_km, resflwi, wdlps, wglps
...
! msub = max number of subbasins
      ...
      real, dimension (:), allocatable :: sub_swgwq !rtb (02-01-2017)
...
!    Drainmod tile equations  08/2006
      ...
      real, dimension (:), allocatable :: sw_gw_q !rtb 05-25-2016
      real, dimension (:), allocatable :: sw_gw_no3 !rtb 01-31-2017
      real, dimension (:), allocatable :: sw_gw_p !rtb 09-06-2017
      real, dimension (:), allocatable :: drn_q !rtb drain 08-08-2017
      real, dimension (:), allocatable :: vadose_thick_hru !rtb 01-04-2017
...
!    Drainmod tile equations  01/2006
      ...
      real, dimension (:), allocatable :: rchrg_p !rtb modflow
...
!! By Zhang for C/N cycling
	! MODIFICATION JJ ADDED 19.4.2024 for DSSAT integration
      real,dimension(:),allocatable::es_layer
